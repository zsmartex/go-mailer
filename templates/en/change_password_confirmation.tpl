<div class="container">
  ...
  <div class="content">
    <h2 class="title">Change Password Verification Code</h2>
    <p>
      Welcome to ZSmartex
      <br>
      Your change password verification code is <span class="confirm_code">{{ .record.code }}</span> It was generated at {{ .record.created_at }} and will be valid for {{ .record.expired_in }} minutes.
      <br>
      <br>
      <br>
      Security Tips:
