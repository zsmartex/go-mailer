<div class="container">
  ...
  <div class="content">
    <h2 class="title">Phone Verification Confirmation Code</h2>
    <p>
      Welcome to ZSmartex
      <br>
      Your phone verification code is <span class="confirm_code">{{ .record.code }}</span> It was generated at {{ .record.created_at }} and will be valid for {{ .record.expired_in }} minutes.
      <br>
      <br>
      <br>
      Security Tips:
