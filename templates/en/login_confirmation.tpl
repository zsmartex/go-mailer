<div class="container">
  ...
  <div class="content">
    ...
    <p>
      Welcome to ZSmartex
      <br>
      Your login verification code is <span class="confirm_code">{{ .record.code }}</span> It was generated at {{ .record.created_at }} and will be valid for {{ .record.expired_in }} minutes.
      <br>
      <br>
      <br>
      Security Tips:
