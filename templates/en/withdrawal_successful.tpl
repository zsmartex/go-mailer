<div class="container">
  ...
  <div class="content">
    <h2 class="title">{{ .record.currency | upcase }} Withdrawal Successful</h2>
    <p>
      Hi {{ .record.user.email }}
      <br>
      You've successfully withdrawn <span class="value">{{ .record.amount }} {{ .record.currency | upcase }}</span> from your account.
      <br>
      <br>
      <span class="value">Withdraw Address:</span> {{ .record.rid }}
      <br>
      <span class="value">Transaction ID:</span> {{ .record.txid }}
      <br>
      <br>
      Security Tips:
      <br>
